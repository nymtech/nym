...
This option is sub-optimal in general. It works today in Switzerland with a specific hardware and ISP setup, documented in [Swiss setup](/operators/residential-ip/home/swiss).
</Callout>
...
That combination is what makes the [Swiss setup](/operators/residential-ip/home/swiss) viable, and it is the model to look for if we want to repeat this elsewhere.


A better way may be to treat any ISP willing to support residential IP based Nym nodes as a candidate for a [formal partnership](/operators/residential-ip/isp) — which is the version of this route that actually scales.
