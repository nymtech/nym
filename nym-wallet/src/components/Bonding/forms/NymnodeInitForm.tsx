...
const NymnodeInitForm = ({ nymnodeData, onNext }: { nymnodeData: MixnodeData; onNext: (data: any) => void }) => {
  ...
  const {
    ...
    handleSubmit,
    setValue,
  } = useForm({ resolver: yupResolver(mixnodeValidationSchema), defaultValues: nymnodeData });
  ...
  return (
    <Stack gap={3}>
      <IdentityKeyFormField
        ...
        fullWidth
        label="Identity Key"
        initialValue={nymnodeData?.identityKey}
...
export default NymnodeInitForm;
