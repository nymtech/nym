...
url: https://nym.com/docs/network/threat-model/examples/wallet
---
...
export const unprotected = requireWalletScenario('unprotected')
export const mixnet = requireWalletScenario('mixnet-ipr')
