...
**This release is introducing new variable having an impact on a a a node's config score, make sure to read the [chapter below](#node-client-account-balance)!**
</Callout>
