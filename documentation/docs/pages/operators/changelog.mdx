...
- [Residential IP research documentation](/operators/residential-ip) released: **Nodes running on such servers will have priority in Nym [Delegatipn program](https://nym.com/delegations-program)**
