...
use nym_mixnet_contract_common::reward_params::{
    ActiveSetUpdate, IntervalRewardingParamsUpdate, Performance,
};
use nym_mixnet_contract_common::{
    ContractStateParams, ExecuteMsg as MixnetExecuteMsg, Gateway, LegacyMixLayer, MixNode, NodeId,
};
    ...
    fn all_execute_variants_are_covered<C: MixnetSigningClient + Send + Sync>(
        ...
        match msg {
            ...
            MixnetExecuteMsg::RewardNode {
                ...
                .reward_mixnode(mix_id, role, performance, None)
                .ignore(),
