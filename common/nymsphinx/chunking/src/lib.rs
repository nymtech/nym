...
//     }
//     //
//     // pub fn with_extra_overhead(&mut self, extra_overhead: usize) {
//     //     self.extra_overhead = Some(extra_overhead)
//     // }
//
...
//         // if some additional bytes were specified to be free
//         if let Some(extra_overhead) = self.extra_overhead {
//             available_size -= extra_overhead;
//         }
//         available_size
//     }
//     //
