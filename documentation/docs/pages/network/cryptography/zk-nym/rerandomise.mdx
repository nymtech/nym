...
Ecash scheme implementation: [`common/nym_offline_compact_ecash/src/scheme`](https://github.com/nymtech/nym/tree/develop/common/nym_offline_compact_ecash/src/scheme)
