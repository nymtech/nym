...
- [LtHash under MSRV 1.86] `lthash-rs` + `sha3` compiled and passed `cosmwasm-check` under rustc 1.96, not yet the pinned 1.86. -> Confirm under the pinned toolchain; fall back to a vendored ~50-line LtHash (SHAKE XOF) if needed.
