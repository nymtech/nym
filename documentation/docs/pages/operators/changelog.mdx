...
As we announced in [`hu` release notes](#service-grant-program-v2), we are starting a second iteration of Service Grant Program bootstrap node operations in key target geographies for Nym and ensures the network can provide a good quality of service.

##### Conditions to join of SGPv2

<Callout type="warning">
**If you are interested to become a part of SGPv2, read the point below. Do *not* buy new machines neither do *not* migrate nodes just yet!**
</Callout>
...
- New submissions can only do one node per operator.
...
- February is the last month we proceed with grants under SGPv1. You are all welcome to join SGPv2 or will remain without grant after March 1st.
...
These locations and slots are approximate and may change based on operators requirements and possibilities.
...
- Have a look into our [ISP list](https://nym.com/docs/operators/community-counsel/isp-list) page
...
- With any findings or feedback, please add it to this [csv](https://github.com/nymtech/nym/blob/develop/documentation/docs/data/csv/isp-sheet.csv), issue a [Pull Request](https://nym.com/docs/operators/community-counsel/add-content) and ping me for review.
