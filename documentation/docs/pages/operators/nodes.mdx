...
- [Nym wallet](nodespreliminary-steps/wallet-preparation)
...
4. **[Run](nodes/nym-node/setup.mdx#initialise--run) the node or [the service](nym-node/configuration.md#systemd)**
