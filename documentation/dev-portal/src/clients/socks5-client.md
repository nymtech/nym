...
* Send the Sphinx packets through the mixnet to a Network requester (a part of Nym Exit Gateway). Packets are shuffled and mixed as they transit the mixnet.
