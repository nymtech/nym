...
- If you bonding `nym-node --mode mixnode` through *Bond mixnode* desktop wallet menu, change manually value of *HTTP port* from deprecated `8000` to `8080` - a generic HTTP port for all modes of `nym-node` binary.
