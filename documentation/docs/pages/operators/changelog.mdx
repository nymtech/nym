...
Patch for `v2024.14-crunch` release. Fixes an issue to allow only one private IP pair & compatibility issues between nym-nodes and older clients.

- [Release binaries](https://github.com/nymtech/nym/releases/tag/XX)
- [`nym-node`](nodes/nym-node.mdx) version `1.1.XX`
