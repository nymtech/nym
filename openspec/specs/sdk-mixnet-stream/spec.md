...
## Purpose
Stream-layer liveness for SDK mixnet streams: acknowledgement of accepted streams through the dialer's reply path, an opt-in establishment wait, and passive liveness introspection, all wire-compatible with peers that predate the extension.
## Requirements
