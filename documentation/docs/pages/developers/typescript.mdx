...
<Callout type="info">
For an HTTP-over-mixnet `fetch()` drop-in, see [**mix-fetch**](/developers/mix-fetch). This page covers the **Mixnet Client** (send / receive raw messages) and **Smart Contracts** (interact with the Nyx chain).
</Callout>
