...
///
/// This demonstrates the feasibility of the NS API optimization where
...
///
/// What to observe:
///   - Phase 1: Client-A registers with a gateway (DH handshake → shared key)
///   - Phase 2: Client-B uses the SAME identity and the SAME shared key
///   - Phase 2: Client-B authenticates (no DH) and gets connected
