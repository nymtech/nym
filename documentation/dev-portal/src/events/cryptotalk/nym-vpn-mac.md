#TODO
1. echange the binary link
2. publish sha256sums
4. change name ob binary on make executable for GUI


# NymVPN alpha on Mac OS
...
* Get your private key for wireguard setup [here](https://nymvpn.com/en/alpha)
...
* Find the entire command with all the needed arguments' values and your wireguard private key for testing purposes can be found on NymVPN alpha webpage [nymvpn.com/en/alpha](https://nymvpn.com/en/alpha)
* Run it with as root, the command will look like this with specified arguments:
```sh
...
* To see all possibilities see command explanation below or run a help command:
```sh
./nym-vpn-cli --help
```
...
```
../../../../../releases/tag/ccc/nym-vpn-cli --help
```
~
