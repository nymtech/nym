...
impl From<v5::registration::RegistredData> for v6::registration::RegisteredData {
    fn from(value: v5::registration::RegistredData) -> Self {
        Self {
...
mod tests {
    ...
    fn upgrade_registered_resp() {
        ...
        let wg_port = 51822;
        let registered_data = v5::registration::RegistredData {
            pub_key,
            private_ips,
            wg_port,
        };
