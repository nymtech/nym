# nym-swizzle Specification

## Purpose
Application-layer traffic-shape obfuscation primitives (randomized delay scheduling, overlapping randomized range chunking, start-edge obfuscation) for privacy-preserving applications such as light-client wallets.
## Requirements
