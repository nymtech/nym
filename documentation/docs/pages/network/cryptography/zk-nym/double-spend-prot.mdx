...
Double spend protection implementation: [`common/nym_offline_compact_ecash/src/scheme`](https://github.com/nymtech/nym/tree/develop/common/nym_offline_compact_ecash/src/scheme)
...
Bloom filter handling: [`nym-api/src/ecash/dkg`](https://github.com/nymtech/nym/tree/develop/nym-api/src/ecash/dkg)
