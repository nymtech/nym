...
- A runnable example connects to a real public lightwalletd (`zec.rocks`) to fetch blocks through the quantized + swizzled sync path, and demonstrates broadcast save-and-resume with a mocked sender (no wallet seed or funds required).
