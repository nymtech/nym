...
- [Ansible guide](/operators/orchestration/ansible): Orchestrating endless nodes using the [Ansible template](https://github.com/nymtech/nym/tree/develop/ansible/nym-node)
