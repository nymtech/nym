...
<Callout type="info" emoji="ℹ️">
    For this example, we will be using the `full-fat` version of the ESM SDK. If you'd like to use the simple ESM one, make sure you add your own web worker files. 
</Callout>
