...
1. Nym operators community started an ISP table called [*Where to host your nym node?*](../legal/community-counselisp-list.mdx), check it out and add your findings!
