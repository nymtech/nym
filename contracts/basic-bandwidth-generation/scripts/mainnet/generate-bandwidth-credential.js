...
async function main() {
    ...
    const bandwidthGenerator = await BandwidthGenerator.attach(contracts.mainnet.BANDWIDTH_GENERATOR); 
    ...
    const erc20nym = await Token.attach(contracts.mainnet.NYM_ERC20); 
