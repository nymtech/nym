---
title: "Demo: routing a whole Ethereum SDK through the mixnet (Railgun)"
description: "How an Ethereum dApp or web3 wallet routes every RPC call made by a third-party SDK through the Nym mixnet, without patching the SDK: global ethers-to-mixFetch routing. Demonstrated by shielding testnet ETH into a Railgun private note."
