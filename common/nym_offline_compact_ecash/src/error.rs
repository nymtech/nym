...
pub enum CompactEcashError {
    ...
    #[error("verification key is invalid for this operation")]
    VerificationKeyTooShort,

    #[error("did not provide the sufficient number of coin index signatures")]
    InsufficientNumberOfIndexSignatures,

    #[error("did not provide the sufficient number of expiration date signatures")]
