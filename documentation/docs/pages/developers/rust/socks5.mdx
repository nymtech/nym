...
You do not have to hardcode a network requester address. [`connect_with`](https://docs.rs/nym-sdk/latest/nym_sdk/mixnet/struct.Socks5MixnetClient.html) takes a `NetworkRequesterSelector` describing how to pick one plus an optional listener address, and connects in a single call. There are three ways to choose:
