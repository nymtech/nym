...
pub mod tests {
    ...
    fn gateway_add() {
        ...
        let info = mock_info("anyone", &tests::fixtures::good_gateway_bond());
        ...
        let info = mock_info("foomper", &tests::fixtures::good_gateway_bond());
        ...
        let info = mock_info("mixnode-owner", &tests::fixtures::good_gateway_bond());
    ...
    fn adding_gateway_without_existing_owner() {
        ...
        let info = mock_info("gateway-owner", &tests::fixtures::good_gateway_bond());
    ...
    fn gateway_remove() {
        ...
        let expected_message = BankMsg::Send {
            ...
            amount: tests::fixtures::good_gateway_bond(),
        };
    ...
    fn validating_gateway_bond() {
        ...
        let mut bond = tests::fixtures::good_gateway_bond();
