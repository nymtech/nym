...
impl<C> NymdClient<C> {
    ...
    pub async fn get_current_interval(&self) -> Result<CurrentIntervalResponse, NymdError>
    where
        C: CosmWasmClient + Sync,
    {
    ...
    {
        todo!()
        // (ExecuteMsg::WithdrawDelegatorReward { mix_identity }, fee)
    }
