...
error: the following required arguments were not provided:
  --id <ID>
  <--credential-data <CREDENTIAL_DATA>|--credential-path <CREDENTIAL_PATH>>
...
Usage: nym-client list-gateways --id <ID>
