...
2. Latency is calculated as an average of 10 attempts

3. Gateway is scored as `"low"`, `"medium"`, `"high"` or `"offline"`, in numbers it means:
    - `"offline"`: Gateway fails the test is 3 and more out of 10 attempts
