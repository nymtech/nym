...
```sh
# MAX: DOWNLOAD BINARY AND PRINT ./nym-node --version HERE and to nodes/nym-node/setup.mdx
```
...
{/* 
Fill these following parts same like in the releases below, using a rough changelog from QA
### Features
