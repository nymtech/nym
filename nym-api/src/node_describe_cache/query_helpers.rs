...
#[pin_project]
struct NodeDescribedInfoMegaFuture<F1, F2, F3, F4, F5, F6, F7>
where
    F1: Future,
    F2: Future,
    F3: Future,
...
impl<F1, F2, F3, F4, F5, F6, F7> Future for NodeDescribedInfoMegaFuture<F1, F2, F3, F4, F5, F6, F7>
where
...
impl<F1, F2, F3, F4, F5, F6, F7> NodeDescribedInfoMegaFuture<F1, F2, F3, F4, F5, F6, F7>
where
    F1: Future,
    F2: Future,
    F3: Future,
