...
pub mod vars {
    ...
    // directory:
    pub const NYMNODE_DIRECTORY_SUBMISSION_ENABLED_ARG: &str =
        "NYMNODE_DIRECTORY_SUBMISSION_ENABLED";
    pub const NYMNODE_DIRECTORY_RECONCILE_SWEEP_INTERVAL_ARG: &str =
        "NYMNODE_DIRECTORY_RECONCILE_SWEEP_INTERVAL";
    pub const NYMNODE_DIRECTORY_DORMANT_BACKOFF_INTERVAL_ARG: &str =
        "NYMNODE_DIRECTORY_DORMANT_BACKOFF_INTERVAL";
    pub const NYMNODE_DIRECTORY_PHINX_EMIT_DEBOUNCE_ARG: &str =
        "NYMNODE_DIRECTORY_PHINX_EMIT_DEBOUNCE";
    pub const NYMNODE_WRITE_RETRY_COUNT_ARG: &str = "NYMNODE_WRITE_RETRY_COUNT";
}
