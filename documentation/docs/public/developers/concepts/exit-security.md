...
For a fuller comparison of Nym against VPNs, Tor, I2P, and end-to-end encryption on threat-model terms, see [Nym vs other systems](/network/threat-model/comparisons).
...
- [The two-layer model](/network/threat-model/two-layer-model): why hiding your identity from the destination (transport) and disciplining what your requests leak (hygiene) are separate problems. This page applies that model at the exit.
