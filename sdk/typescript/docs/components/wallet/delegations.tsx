...
const DelegationsComponent = () => {
  const { delegations, doDelegate, delegationLoader, withdrawLoading, withdrawRewards, unDelegateAll, unDelegateAllLoading } = useWalletContext();
    ...
    <Paper style={{ marginTop: '1rem', padding: '1rem' }}>
      <Box padding={3}>
        ...
        <Box marginTop={3}>
          ...
          <Box>
            <Button variant="outlined" onClick={() => withdrawRewards()} disabled={withdrawLoading}>
