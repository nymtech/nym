...
This setup is recommended for one or a small number of nodes. 
      ...
      <Steps>
###### 1. Get the address of your client
...
This setup is recommended for people orchestrating several nodes. It takes up to 30 min to prepare, but allows for timeless changes of some or all nodes any time in the future. 
      <Steps>
