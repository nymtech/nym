...
### Operator & Developer Update

LP Gateway & Client Enhancements
...
- [Enhanced CI workflow with feature inputs](https://github.com/nymtech/nym/pull/6462)
- [On-disk cache persistence for major Nym API caches](https://github.com/nymtech/nym/pull/6302)

Data & Migrations

- [Fixed migrations in the Data Observatory](https://github.com/nymtech/nym/pull/6271)

Monitoring & Diagnostics

- The Diagnostic Tool is a standalone binary for network diagnostics. It performs DNS, HTTP, and gateway connectivity tests, helping developers identify connectivity issues and monitor network performance. It can also run via the daemon CLI for convenience.
Read the full guide [here](https://nym.com/docs/developers/tools/diagnostic-tool)
- Socks5 Score Calculation is performed by the Gateway probe, which tests nym-node --mode exit-gateway instances over Socks5 and assigns a latency-based rating: high, medium, low, or offline. Read the full guide [here](https://nym.com/docs/operators/performance-and-testing#socks5-score-calculation-process)
