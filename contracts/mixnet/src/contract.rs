...
pub const INITIAL_MIXNODE_STAKE_REWARD_RATE: u64 = 110;
pub const INITIAL_GATEWAY_STAKE_REWARD_RATE: u64 = 110;
...
fn default_initial_state(owner: Addr) -> State {
    ...
    let mixnode_stake_reward_rate = Decimal::percent(INITIAL_MIXNODE_STAKE_REWARD_RATE);
    let gateway_stake_reward_rate = Decimal::percent(INITIAL_GATEWAY_STAKE_REWARD_RATE);
    ...
    State {
        ...
        params: StateParams {
            ...
            mixnode_stake_reward_rate,
            gateway_stake_reward_rate,
