---
title: "TcpProxy Architecture"
description: "Architecture of the Nym TcpProxy module: client and server design, byte framing, session management, and message ordering over the mixnet."
...
<Callout type="error">
**This module is unmaintained.** See the [Stream module](../stream) for the actively developed replacement. Existing users should plan to migrate when possible.
</Callout>
...
After receiving the packets, it can then forward the recorded bytes to the requesting process.
