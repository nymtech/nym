...
Core ecash implementation: [`common/nym_offline_compact_ecash`](https://github.com/nymtech/nym/tree/develop/common/nym_offline_compact_ecash)
...
Key generation: [`common/nym_offline_compact_ecash/src/scheme/keygen.rs`](https://github.com/nymtech/nym/blob/develop/common/nym_offline_compact_ecash/src/scheme/keygen.rs)
...
Zero-knowledge proofs: [`common/nym_offline_compact_ecash/src/proofs`](https://github.com/nymtech/nym/tree/develop/common/nym_offline_compact_ecash/src/proofs)
...
Credential handling: [`common/credentials`](https://github.com/nymtech/nym/tree/develop/common/credentials)
