...
<Callout>
To see the list of current residential IP nodes, run this command in your terminal:
~~~sh
bash -c "$(curl -fsSL https://gist.githubusercontent.com/serinko/81d2565bea4b0a32b57d1f5981497d7a/raw/c9e03a9c6542fe417ec65c93ec69db6f098aba36/get_nym_residential_ip_nodes.sh)"
~~~
</Callout>
...
| --- | --- | --- |
| [Mislabeled VPS ranges](/operators/residential-ip/vps) | Yes, but fragile | Cheap and immediate but it can dissapear as `residential` without notice |
| [ISP-tier IP blocks and BYOIP](/operators/residential-ip/byoip) | Yes | Lease ISP-registered space, announce it on bare metal or colo |
| [Partnership with a small ISP](/operators/residential-ip/isp) | Yes, slowly | Cleanest lineage, compounds over time, relationship work building social networks |
| [Mobile 4G/5G gateways](/operators/residential-ip/mobile) | Poorly | Highest trust score of any IP class, hard to scale |
| [Home-hosted nodes](/operators/residential-ip/home) | No | Sub-optimal in general, but works in the [Swiss setup](/operators/residential-ip/home/swiss) |
...
If a vendor can't tell us the ASN and the registration lineage, we can assume it won't survive verification. See the [vendor research](/operators/residential-ip/vps) for which ones cleared this bar and which did not.
</AccordionTemplate>
...
- Re-check the same IP after two to four weeks of live exit traffic to see whether classification or reputation drifts. This is the durability question in the [BYOIP route](/operators/residential-ip/byoip)
...
- Look for a [small-ISP partnership](/operators/residential-ip/isp) pitch in parallel. 
