...
impl<C: SigningCosmWasmClient + Sync + Send> VestingSigningClient for NymdClient<C> {
    ...
    async fn vesting_track_unbond_gateway(
        ...
        let fee = self.client.operation_fee(Operation::TrackUnbondGateway);
    ...
    async fn vesting_track_unbond_mixnode(
        ...
        let fee = self.client.operation_fee(Operation::TrackUnbondMixnode);
    ...
    async fn withdraw_vested_coins(&self, amount: Coin) -> Result<ExecuteResult, NymdError> {
        let fee = self.client.operation_fee(Operation::WithdrawVestedCoins);
    ...
    async fn vesting_track_undelegation(
        ...
        let fee = self.client.operation_fee(Operation::TrackUndelegation);
    ...
    async fn create_periodic_vesting_account(
        ...
        let fee = self
            .client
            .operation_fee(Operation::CreatePeriodicVestingAccount);
