...
pub mod vars {
    ...
    pub const NYMNODE_WG_ALLOW_LEGACY_AUTHENTICATOR_ARG: &str =
        "NYMNODE_WG_ALLOW_LEGACY_AUTHENTICATOR";
    ...
    pub const NYMNODE_FREE_TIER_ENABLED_ARG: &str = "NYMNODE_FREE_TIER_ENABLED";
    pub const NYMNODE_FREE_TIER_SIGNER_PUBKEY_ARG: &str = "NYMNODE_FREE_TIER_SIGNER_PUBKEY";
    // hidden free-tier tuning knobs (not shown in --help)
    pub const NYMNODE_FREE_TIER_WALLED_GARDEN_WHITELIST_ARG: &str =
        "NYMNODE_FREE_TIER_WALLED_GARDEN_WHITELIST";
    pub const NYMNODE_FREE_TIER_POOL_BANDWIDTH_PER_SECOND_ARG: &str =
        "NYMNODE_FREE_TIER_POOL_BANDWIDTH_PER_SECOND";
    pub const NYMNODE_FREE_TIER_BANDWIDTH_ALLOWANCE_ARG: &str =
        "NYMNODE_FREE_TIER_BANDWIDTH_ALLOWANCE";
