...
mod tests {
    ...
    fn test_summary_history_dto_try_from() {
        ...
        let summary_history: crate::http::models::SummaryHistory = summary_history_dto.try_into().unwrap();
    ...
    fn test_gateway_sessions_record_try_from() {
        ...
        let session_stats: crate::http::models::SessionStats = gateway_sessions_record.try_into().unwrap();
    ...
    fn test_nym_node_dto_try_from() {
        ...
        let nym_node_dto = crate::db::models::NymNodeDto {
            ...
            node_role: serde_json::json!(nym_validator_client::nym_nodes::NodeRole::Mixnode { layer: 1 }),
        ...
        let skimmed_node: nym_validator_client::nym_api::SkimmedNode = nym_node_dto.try_into().unwrap();
    ...
    fn test_nym_node_insert_record_new() {
        ...
        assert_eq!(record.ed25519_identity_pubkey, ed25519_pk.to_base58_string());
        ...
        assert_eq!(record.node_role, serde_json::json!(nym_validator_client::nym_nodes::NodeRole::Mixnode { layer: 1 }));
        assert_eq!(
    ...
    fn test_scraper_node_info_contact_addresses() {
        use crate::db::models::{ScraperNodeInfo, ScrapeNodeKind};
    ...
    fn test_nym_node_dto_with_invalid_performance() {
        ...
        let result: Result<nym_validator_client::nym_api::SkimmedNode, _> = nym_node_dto.try_into();
        assert!(result.is_err());
        assert!(result.unwrap_err().to_string().contains("can't parse Percent"));
    }
