...
mod test_constructor {
    ...
    fn test_constructor_sets_database() {
        let db = super::super::db::MixminingDb::new();
        let service = StakeService::new(db.clone());
