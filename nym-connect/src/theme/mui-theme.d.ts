...
declare module '@mui/material/styles' {
  ...
  /**
   * A palette definition only for the Nym Mixnet that extends the Nym palette
   */
  interface NymMixnetPalette {
    nymMixnet: {};
  }

  interface NymPaletteAndNymMixnetPalette {
    nym: NymPalette & NymMixnetPalette;
  }

  type NymPaletteAndNymMixnetPaletteOptions = Partial<NymPaletteAndNymMixnetPalette>;
  ...
  interface Palette extends NymPaletteAndNymMixnetPalette {}
  interface PaletteOptions extends NymPaletteAndNymMixnetPaletteOptions {}
}
