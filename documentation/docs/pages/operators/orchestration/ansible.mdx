...
- In case of not needing some of them, delete them (ie when running `--mode mixnode` you can delete everything from `--hostname` to `--announce-wss-port`)
