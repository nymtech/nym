...
The [`nym/sdk/ffi`](https://github.com/nymtech/nym/tree/develop/sdk/ffi) directory has the following structure:
...
- `split_sender()`: splitting a client into sender and receiver for concurrent send/receive.
- Custom network topologies.
- `Socks5::new()`: creation and use of the SOCKS5/4a/4 proxy client.

See the [examples on GitHub](https://github.com/nymtech/nym/tree/develop/sdk/rust/nym-sdk/examples) for Rust implementations of these features.
