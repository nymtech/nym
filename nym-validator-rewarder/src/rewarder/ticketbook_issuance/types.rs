...
impl From<MonitoringResultsInner> for TicketbookIssuanceResults {
        ...
        TicketbookIssuanceResults {
            ...
            api_runners: value
                ...
                .map(|runner| {
                    ...
                    OperatorIssuing {
                        issued_ratio,
                        issued_ticketbooks: runner.issued_credentials(),
                        validated_ticketbooks: runner.validated_credentials(),
...
pub struct OperatorIssuing {
    ...
    pub validated_ticketbooks: u32,
    // merkle stuff here probably
}
