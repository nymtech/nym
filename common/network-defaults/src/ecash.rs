...
impl TicketTypeRepr {
    ...
    pub const WIREGUARD_EXIT_TICKET_SIZE: u64 = 500 * 1024 * 1024; // 500 MB
    pub const MIXNET_ENTRY_TICKET_SIZE: u64 = 100 * 1024 * 1024; // 100 MB
    pub const MIXNET_EXIT_TICKET_SIZE: u64 = 100 * 1024 * 1024; // 100 MB
