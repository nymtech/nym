...
pub(crate) async fn execute(
    ...
    identity_key: nym_cli_commands::validator::mixnet::operators::client_key::MixnetOperatorsIdentityKey,
    _network_details: &NymNetworkDetails,
) -> anyhow::Result<()> {
    let res = match identity_key.command {
        nym_cli_commands::validator::mixnet::operators::client_key::MixnetOperatorsIdentityKeyCommands::Sign(sign_args) => {
