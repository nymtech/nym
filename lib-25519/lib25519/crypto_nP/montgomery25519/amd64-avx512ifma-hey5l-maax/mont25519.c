                      ...
                      const unsigned char *p)
{
  ...
  crypto_uint64_vec4x1 a[5] = {{0}};
  crypto_uint64_vec4x1 b[5] = {{0}};
  fe25519_base52_5l u,v;
  fe25519 z[2];  
  ...
  fe25519_unpack(z,p);
  fe25519_to_base52_5l(&u,z);  

  b[0][0] = b[0][3] = a[0][2] = 1; a[0][1] = 486662;
	
  for (i=0;i<5;i++) {b[i][2] = u.l[i]; a[i][3] = u.l[i];}

  mladder(b,a,e);

  for (i=0;i<5;i++) {u.l[i] = b[i][0]; v.l[i] = b[i][1];}

  fe25519_from_base52_5l(z,&u);
  fe25519_from_base52_5l(z+1,&v);
