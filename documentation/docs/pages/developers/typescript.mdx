...
For background on Sphinx, gateways, cover traffic, and the mixnet itself, see [Key Concepts](/developers/concepts).

## Packages

| Package | Variant | When to use |
|---|---|---|
| `@nymproject/sdk` | ESM | Modern project, configurable bundler. See [Bundling](/developers/typescript/bundling). |
...
| [Bundling](/developers/typescript/bundling) | Webpack and esbuild configurations for WASM + Web Workers. |
