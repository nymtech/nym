...
apply_port_allowlist() {
  ...
  declare -A PORT_MAPPINGS=(
    ...
    # Within WorldOfWorldcraft7
    #["RainbowSixSiege1"]="6015"
    ...
    ["TeamSpeakVoice"]="9987"
    ["DashNetwork"]="9999"
    # Within RainbowSixSiege2
    #["NDMP"]="10000"
    #["TeamSpeakQuery"]="10011-10080"
    ["RainbowSixSiege2"]="10000-10099"
    ["TeamSpeakHTTPS"]="10443"
    ["OpenPGP"]="11371"
    ["EpicGames1"]="12000-65000"
    # Within EpicGames1
    #["eufySecurity1"]="12306-12308"
    #["RainbowSixSiege3"]="13000-13005"
    #["RainbowSixSiege4"]="13200"
    #["RainbowSixSiege5"]="14000-14024"
    #["MoneroMiningPools3"]="14444"
    #["Monero"]="18080-18081"
    #["MoneroRPC"]="18089"
    ...
    # Within DiscordVoiceChat1 range
    #["Electrum2"]="50001" 
    #["ElectrumSSL"]="50002"    
    #["MOSH"]="60000-61000"
    #["Mumble"]="64738"
