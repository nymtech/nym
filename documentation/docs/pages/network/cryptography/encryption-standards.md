...
For detailed specifications, see the [Sphinx paper](https://cypherpunks.ca/~iang/pubs/Sphinx_Oakland09.pdf), the [Coconut paper](https://arxiv.org/pdf/1802.07344) (credential scheme foundation), the [WireGuard protocol specification](https://www.wireguard.com/protocol/), and the [Nym Whitepaper](https://nym.com/nym-whitepaper.pdf).
