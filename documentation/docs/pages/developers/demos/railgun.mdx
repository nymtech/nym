...
description: "How an Ethereum dApp or web3 wallet routes every RPC request made by a third-party SDK through the Nym mixnet, without patching the SDK. Global ethers-to-mixFetch routing. The example shields testnet ETH into a Railgun private note."
