...
Options:
  ...
  -o, --output <OUTPUT>
      ...
      --wireguard-metadata-announced-port <WIREGUARD_METADATA_ANNOUNCED_PORT>
          Metadata port announced to external clients wishing to connect to the wireguard interface. Useful in the instances where the node is behind a proxy [env: NYMNODE_WG_METADATA_ANNOUNCED_PORT=]
