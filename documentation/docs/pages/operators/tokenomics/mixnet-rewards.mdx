...
Let's compare 3 nodes to see their rewards, for simplicity all of them having maximum performance and stake saturation, being active in the same epoch with reward budget of 5_000 NYM, circulating supply is 800_000_000 NYM and node work fraction 1 / 240, only their bond differs:
...
```
node1_epoch_rewards = 5_000 * ( ( 1 / 240 ) + 0.3 * ( 100 / 800_000_000) ) + 1 / ( 1 + 0.3 )
node2_epoch_rewards = 5_000 * ( ( 1 / 240 ) + 0.3 * ( 250_000 / 800_000_000) ) + 1 / ( 1 + 0.3 )
node3_epoch_rewards = 5_000 * ( ( 1 / 240 ) + 0.3 * ( 1_000_000 / 800_000_000) ) + 1 / ( 1 + 0.3 )
```

The result:
```
node1_epoch_rewards = 21.6027 NYM
node2_epoch_rewards = 22.0713 NYM
node3_epoch_rewards = 23.4775 NYM
```

Difference between the smallest possible bond 100 NYM and very big bond 1mm NYM (around full stake saturation point) is about 8% of increase in epoch rewards. 
</ AccordionTemplate>
