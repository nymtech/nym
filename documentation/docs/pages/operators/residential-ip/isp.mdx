...
| [Init7](https://www.init7.net/de) (CH) | AS13030, own backbone, no reseller layer, net-neutral by policy, and tolerant of Tor traffic on their ASN. See the [Swiss setup](/operators/residential-ip/home/swiss) for a working deployment on their network |

See the [full provider research](/operators/residential-ip/vps#provider-research) for the rest of the networks Nym nodes currently run on, several of which are candidates for a formal arrangement.
