...
- [`show_balances.py`](https://github.com/nymtech/nym/tree/develop/scripts/nym-node-setup/auto-bond/show_balances.py): Shows all accounts balances if provided with Nyx accounts (`account` column)
