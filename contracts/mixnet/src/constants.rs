...
pub fn default_node_costs<S: Into<String>>(rewarding_denom: S) -> NodeCostParams {
    ...
    NodeCostParams {
        ...
        interval_operating_cost: Coin::new(40_000_000, rewarding_denom),
    }
}
...
pub const NYM_NODE_BOND_DEFAULT_RETRIEVAL_LIMIT: u32 = 100;
pub const NYM_NODE_BOND_MAX_RETRIEVAL_LIMIT: u32 = 150;
