...
We’re excited to announce that the first **nym-node release of 2026**. 
...
To implement the changes and ensure that the nodes have expected perfomance, please re-run NTM following thse steps:
