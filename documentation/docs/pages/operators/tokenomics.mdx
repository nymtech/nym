...
* For a more comprehensive overview, token live data and graphs, visit a community managed dashboard [*explorer.nym.spectredao.net/dashboard*](https://explorer.nym.spectredao.net/dashboard)
...
NYM token is capped at 1b. Visit [SpectreDAO dashboard](https://explorer.nym.spectredao.net/dashboard) to see live data and graphs.
