...
export const MIXNODES_BY_ID =
  'https://testnet-milhon-explorer.nymtech.net/api/ping';
export const GATEWAYS_API =
  'https://testnet-milhon-validator1.nymtech.net/api/v1/gateways';
...
export const UPTIME_STORY_API = `https://testnet-milhon-validator1.nymtech.net/api/v1/status/mixnode`; // add ID then '/history' to this.
export const MIXNODE_STATS_API = `https://testnet-milhon-explorer.nymtech.net/api/mix-node`; // add ID then `/stats` or `/delegations` to this.
export const DELEGATIONS_API = `https://testnet-milhon-explorer.nymtech.net/api/mix-node`; // add ID then `/stats` or `/delegations` to this.
