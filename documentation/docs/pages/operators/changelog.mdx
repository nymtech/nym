...
- [Release Binaries](https://github.com/nymtech/nym/releases/tag/nym-binaries-2026.19-fuqing)
- [`nym-node`](nodes/nym-node.mdx) version `1.41.0`

```sh
FILL OUTPUT OF NEW ./nym-node --version
```

### Operator & Developer Updates

<Callout type="warning" emoji="⚠️">
**Since Friday, September 4th, 12:00 UTC there is a new variable having an impact on a [node's config score](/operators/tokenomics/mixnet-rewards#has-sufficient-tokens), make sure to read the [chapter below](#node-client-account-balance) in order to be up to date.**
</Callout>

- [**Ansible playbook `system-maintenance.yml` updated & extended:**] Read more in [a step-by-step guide](/operators/orchestration/ansible#4-system-maintenance)
- [**New hypervisor hygiene script & guide:**](/operators/troubleshooting/vps-isp#system-hygiene) for operators who [self-virtualise a dedicated server](/operators/nodes/preliminary-steps/vps-setup/advanced) with KVM and libvirt


{/*
REPLACE THIS COMMENT WITH NEW DEV CHANGELOG SORTED BY
### Features
### Bugfix
...
- [Release Binaries](https://github.com/nymtech/nym/releases/tag/nym-binaries-v2026.18-essaouria)
- [`nym-node`](nodes/nym-node.mdx) version `1.40.0`

```sh
Binary Name:        nym-node
Build Timestamp:    2026-09-16T16:26:01.619074540Z
Build Version:      1.40.0
Commit SHA:         2631de5b04b1e5b300729c4af8d48f5783db865f
Commit Date:        2026-09-16T14:50:42.000000000+02:00
Commit Branch:      HEAD
...
- [Residential IP research documentation](/operators/residential-ip) released: **Nodes running on such servers will have priority in Nym [Delegation program](https://nym.com/delegations-program)**


### Features

- [LP: claim UM token when out of tickets](https://github.com/nymtech/nym/pull/7110)

- [Increase default replay window to 8k (following wireguard) + make it configurable for easier changes in the future](https://github.com/nymtech/nym/pull/7103)

- [Manually control sending counters](https://github.com/nymtech/nym/pull/7102)

- [Allow future lp compat](https://github.com/nymtech/nym/pull/7099)

- [`LP-DATA` Separation of Lp Registration and dVPN Registration](https://github.com/nymtech/nym/pull/7112)

- [Internal DNS work](https://github.com/nymtech/nym/pull/7104)

### Bugfix

- [Bug fixes](https://github.com/nymtech/nym/pull/7145)

- [Change snapshot retrieval to be best-effort](https://github.com/nymtech/nym/pull/7132)

- [Don't panic on Socks5 Controller Sender failure](https://github.com/nymtech/nym/pull/7114)

- [Fix various bugs within `nym-api` making future `re-DKG` smoother [vol5]](https://github.com/nymtech/nym/pull/7107)

- [Fix various bugs within `nym-api` making future `re-DKG` smoother [vol4]](https://github.com/nymtech/nym/pull/7096)

- [Fix various bugs within `nym-api` making future `re-DKG` smoother [vol3]](https://github.com/nymtech/nym/pull/7088)

- [Fix various bugs within `nym-api` making future `re-DKG` smoother [vol2]](https://github.com/nymtech/nym/pull/7082)

- [Fix various bugs within `nym-api` making future `re-DKG` smoother [vol1]](https://github.com/nymtech/nym/pull/7069)

### Refactors & Maintenance

- [Additional logs when performing node lookup](https://github.com/nymtech/nym/pull/7154)

- [Revert manually setting LP AEAD nonce](https://github.com/nymtech/nym/pull/7130)


## `v2026.17-djibouti`

- [Release Binaries](https://github.com/nymtech/nym/releases/tag/nym-binaries-v2026.17-djibouti)
- [`nym-node`](nodes/nym-node.mdx) version `1.39.0`

```sh
Binary Name:        nym-node
Build Timestamp:    2026-09-02T12:05:33.148701650Z
Build Version:      1.39.0
Commit SHA:         7151978829fe52f3730fb09ad2e2177aa4e201c1
Commit Date:        2026-09-02T14:01:40.000000000+02:00
Commit Branch:      HEAD
rustc Version:      1.97.0
rustc Channel:      stable
cargo Profile:      release
...
<Callout type="warning" emoji="⚠️">
**This release is introducing new variable having an impact on a [node's config score](/operators/tokenomics/mixnet-rewards#has-sufficient-tokens), make sure to read the [chapter below](#node-client-account-balance)!**

This rule will come to action on Friday, September 4th, 12:00 UTC.
</Callout>

#### Node Client Account balance

Every node has its own Nyx account generated with the initial `run` command. This account has its mnemonic stored in `$HOME/.nym/nym-nodes/<NODE-ID>/data/cosmos_mnemonic`. The balance of every node's client account is accessible on a public endpoint `<NODE_IPv4>:8080/api/v2/auxiliary-details` or `<HOSTNAME>/api/v2/auxiliary-details`. 

**From this release onward every node having less than 1 NYM balance on this account will have its [config score](/operators/performance-and-testing#mixnet-node-performance-calculation) multiplied by 0.8 (80%).** This rule is to ensure that operators top up their nodes accounts to enable their Nym nodes pushing config changes up to the blockchain as well as collect bandwidth tickets (for upcoming ticket based rewarding).

**Please follow [these steps](/operators/nodes/nym-node/bonding#fund-nym-node-client-nyx-account) to top up your node account.**

> Note: The `nym-api` endpoint updates every 24h, so don't expect to see your updated balance immediately.

### Features

- [Add config score penalty for nodes incapable of sending nyx transactions](https://github.com/nymtech/nym/pull/7073)

- [Add additional check for signer status in the validator-status-check tool](https://github.com/nymtech/nym/pull/7068)

- [Introduce Geolocator service alongside associated contract](https://github.com/nymtech/nym/pull/7055)

- [Directory node publishing](https://github.com/nymtech/nym/pull/7013)

- [Directory checkpoint bootstrapping](https://github.com/nymtech/nym/pull/7004)

- [Directory Attestation Provider](https://github.com/nymtech/nym/pull/6954)

- [Expose nym-api public keys + proof of possession](https://github.com/nymtech/nym/pull/6949)

- [Directory Client: Attested Anchor](https://github.com/nymtech/nym/pull/6948)

- [Directory Client: TM Light Client Anchor](https://github.com/nymtech/nym/pull/6941)

- [Verifiable Directory Contract retrieval](https://github.com/nymtech/nym/pull/6936)

- [Directory Contract](https://github.com/nymtech/nym/pull/6933)

### Bugfix

- [Djubouti nym api](https://github.com/nymtech/nym/pull/7097)

- [Don't use hickory within the credential proxy](https://github.com/nymtech/nym/pull/7091)

- [Dont inline mixnet initialise function](https://github.com/nymtech/nym/pull/7090)

- [Don't crash node startup over one corrupted peer record](https://github.com/nymtech/nym/pull/7065)

- [Reject packets to unknown clients](https://github.com/nymtech/nym/pull/7061)

- [Network Details v2 Endpoint Type](https://github.com/nymtech/nym/pull/7051)

- [Bridge_client_params must survive --write-changes](https://github.com/nymtech/nym/pull/7049)

- [CanHandshake must reflect a real WireGuard handshake, not local interface state](https://github.com/nymtech/nym/pull/7047)

- [Bracket IPv6 addresses in the WireGuard endpoint string](https://github.com/nymtech/nym/pull/7046)

### Refactors & Maintenance

- [Removed support for outfox packets](https://github.com/nymtech/nym/pull/7048)


## `v2026.16-como`

- [Release Binaries](https://github.com/nymtech/nym/releases/tag/nym-binaries-v2026.17-djibouti)
- [`nym-node`](nodes/nym-node.mdx) version `1.38.0`

```sh
nym-node
Binary Name:        nym-node
Build Timestamp:    2026-08-19T10:45:32.504170490Z
Build Version:      1.38.0
Commit SHA:         d28fed9addf4d612e65f19dfc63a5839bfb1df84
Commit Date:        2026-08-18T10:27:35.000000000+02:00
Commit Branch:      HEAD
rustc Version:      1.97.0
rustc Channel:      stable
cargo Profile:      release
...
- **New visual documentation** on [threat model](/network/threat-model), [`nym-smoldvpn`](/developers/smoldvpn) and [`nym-swizzle`](/developers/swizzle)

- [Delegation Program](https://nym.com/delegations-program) account is fully utilised. From now on delegations will happen every two weeks and only to a limited amount of nodes proportional to the amount of available NYM tokens. 

### Features

- [Como Network Details v2 Endpoint Type](https://github.com/nymtech/nym/pull/7052)

- [Add nym-lthash incremental multiset-hash crate](https://github.com/nymtech/nym/pull/7025)

- [Add several more API options](https://github.com/nymtech/nym/pull/7007)

- [[BandwidthController] Background global-data fetching + global-data-aware readiness](https://github.com/nymtech/nym/pull/6988)

- [SDK: nym-swizzle](https://github.com/nymtech/nym/pull/6984)

- [Networking and Bootstrapping configuration changes](https://github.com/nymtech/nym/pull/6901)

### Bugfix

- [Change constraints on stress testing results table to allow for orchestrator database reset](https://github.com/nymtech/nym/pull/7035)

- [Don't report end-of-stream from ChannelDevice](https://github.com/nymtech/nym/pull/7009)

- [HTTP Error handling](https://github.com/nymtech/nym/pull/7006)

- [NTM: Hotfix](https://github.com/nymtech/nym/pull/6971)

### Refactors & Maintenance

- [Patch updates](https://github.com/nymtech/nym/pull/7016)

- [Upgrade rand 0.9 uses to rand 0.10](https://github.com/nymtech/nym/pull/7014)

- [Forbid direct slice indexing in core crypto crates](https://github.com/nymtech/nym/pull/6983)


## `v2026.15-bydgoszcz`

- [Release Binaries](https://github.com/nymtech/nym/releases/tag/nym-binaries-v2026.15-bydgoszcz)
- [`nym-node`](nodes/nym-node.mdx) version `1.37.0`

```sh
nym-node
Binary Name:        nym-node
Build Timestamp:    2026-08-05T08:23:29.320237429Z
Build Version:      1.37.0
Commit SHA:         451c2aa3692fc4dc00041b74a352d4158176d9c0
Commit Date:        2026-08-05T10:21:45.000000000+02:00
Commit Branch:      HEAD
rustc Version:      1.97.0
rustc Channel:      stable
cargo Profile:      release
...
**[NIP-14](https://governator.nym.com/proposal/prop-db4bbd01-8a32-46f9-82ae-5fe0ca68cddc) passed & [NTM updated](https://github.com/nymtech/nym/pull/7031): More services for NymVPN users are opened!** Please re-run [Nym network tunnel manager](https://raw.githubusercontent.com/nymtech/nym/refs/heads/develop/scripts/nym-node-setup/network-tunnel-manager.sh) (NTM) on your hosting servers.
</Callout>

- [NTM (`network-tunnel-manager`) tests are fixed to prompt the correct bands](https://github.com/nymtech/nym/pull/6971/changes)
...
- [Cherry pick new domain](https://github.com/nymtech/nym/pull/7018)

- [Update new domain](https://github.com/nymtech/nym/pull/7017)

- [Add openspec for network monitors V1 and V3](https://github.com/nymtech/nym/pull/6977)

- [Bandwidth controller: allow scoping ticketbook acquisition to specific types](https://github.com/nymtech/nym/pull/6976)

- [Use `SkewManager` with registration clients.](https://github.com/nymtech/nym/pull/6973)

- [Service provider ephemeral credential storage](https://github.com/nymtech/nym/pull/6961)

- [SDK: add `smol-dvpn` to provide per app user space tunnels](https://github.com/nymtech/nym/pull/6953)

- [Leverage `cfg_attr` to avoid code duplication](https://github.com/nymtech/nym/pull/6950)

### Bugfix

- [IPR selection and mtu](https://github.com/nymtech/nym/pull/6962)

### Refactors & Maintenance

- [2 `clippy` 2 furious](https://github.com/nymtech/nym/pull/6970)

- [`clippy` mc clipface](https://github.com/nymtech/nym/pull/6967)
