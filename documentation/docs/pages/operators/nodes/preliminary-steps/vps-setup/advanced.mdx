...
Since we chosen to setup the VM with a cloud init, we will have to generate a few keys on the VM. All of them will be saved to this location: `/etc/ssh/<KEY>`
