...
The four browser packages below share one shared mixnet tunnel ([`mix-tunnel`](/developers/mix-tunnel)) and exit at an IPR (Internet Packet Router) gateway. Install only what you need; they all reuse the same WASM instance under the hood.
