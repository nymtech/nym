...
CREATE INDEX verified_tickets_gateway_id_index ON verified_tickets (gateway_id);
CREATE INDEX verified_tickets_verified_at_index ON verified_tickets (verified_at);
