...
pub(crate) mod sealed {
    ...
    use crate::models::network_monitor::v3::{
        LivenessTestBatchSubmissionContent, StressTestBatchSubmissionContent,
    };
    use crate::models::{
    ...
    // v3 liveness testing
    impl Sealed for LivenessTestBatchSubmissionContent {}
}
