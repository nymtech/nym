...
const crypto_uint64 pmask1[]     = { 0x000FFFFFFFFFFFFF,0x000FFFFFFFFFFFFF,0x000FFFFFFFFFFFFF,0x000FFFFFFFFFFFFF };
const crypto_uint64 pmask2[]     = { 0xFFF0000000000000,0xFFF0000000000000,0xFFF0000000000000,0xFFF0000000000000 };
const crypto_uint64 pmask3[]     = { 0x000000FFFFFFFFFF,0x000000FFFFFFFFFF,0x000000FFFFFFFFFF,0x000000FFFFFFFFFF };
const crypto_uint64 pmask4[]     = { 0xFFFFFF0000000000,0xFFFFFF0000000000,0xFFFFFF0000000000,0xFFFFFF0000000000 };
const crypto_uint64 pmask5[]     = { 0x000000000FFFFFFF,0x000000000FFFFFFF,0x000000000FFFFFFF,0x000000000FFFFFFF };
const crypto_uint64 pmask6[]     = { 0xFFFFFFFFF0000000,0xFFFFFFFFF0000000,0xFFFFFFFFF0000000,0xFFFFFFFFF0000000 };
const crypto_uint64 pmask7[]     = { 0x000000000000FFFF,0x000000000000FFFF,0x000000000000FFFF,0x000000000000FFFF };
const crypto_uint64 pmask8[]     = { 0xFFFFFFFFFFFF0000,0xFFFFFFFFFFFF0000,0xFFFFFFFFFFFF0000,0xFFFFFFFFFFFF0000 };
const crypto_uint64 upmask1[]    = { 0x000FFFFFFFFFFFFF,0x000FFFFFFFFFFFFF,0x000FFFFFFFFFFFFF,0x000FFFFFFFFFFFFF };
const crypto_uint64 upmask2[]    = { 0x0000000000000FFF,0x0000000000000FFF,0x0000000000000FFF,0x0000000000000FFF };
const crypto_uint64 upmask3[]    = { 0x000FFFFFFFFFF000,0x000FFFFFFFFFF000,0x000FFFFFFFFFF000,0x000FFFFFFFFFF000 };
const crypto_uint64 upmask4[]    = { 0x0000000000FFFFFF,0x0000000000FFFFFF,0x0000000000FFFFFF,0x0000000000FFFFFF };
const crypto_uint64 upmask5[]    = { 0x000FFFFFFF000000,0x000FFFFFFF000000,0x000FFFFFFF000000,0x000FFFFFFF000000 };
const crypto_uint64 upmask6[]    = { 0x0000000FFFFFFFFF,0x0000000FFFFFFFFF,0x0000000FFFFFFFFF,0x0000000FFFFFFFFF };
const crypto_uint64 upmask7[]    = { 0x000FFFF000000000,0x000FFFF000000000,0x000FFFF000000000,0x000FFFF000000000 };
