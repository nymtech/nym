...
impl PrometheusMetric {
    ...
    fn to_registrable_metric(&self) -> Option<Metric> {
        ...
        match self {
            ...
            PrometheusMetric::MixnetLpMessagesReceived { .. } => Metric::new_int_gauge(&name, help),
            PrometheusMetric::MixnetLpMessagesProcessed { .. } => {
                Metric::new_int_gauge(&name, help)
            }
            ...
            PrometheusMetric::MixnetLpEgressOverloadedDropped => Metric::new_int_gauge(&name, help),
            ...
            PrometheusMetric::MixnetLpPacketsReceivedRate => Metric::new_float_gauge(&name, help),
            PrometheusMetric::MixnetLpPacketsForwardedRate => Metric::new_float_gauge(&name, help),
            PrometheusMetric::MixnetLpRoutingFilterDroppedRate => {
                Metric::new_float_gauge(&name, help)
            }
            PrometheusMetric::MixnetLpMessagesReceivedRate => Metric::new_float_gauge(&name, help),
            PrometheusMetric::MixnetLpMessagesProcessedRate => Metric::new_float_gauge(&name, help),
            PrometheusMetric::MixnetLpMalformedPacketsRate => Metric::new_float_gauge(&name, help),
            PrometheusMetric::MixnetLpExcessiveDelayPacketsRate => {
                Metric::new_float_gauge(&name, help)
            }
            PrometheusMetric::MixnetLpReplayedPacketsRate => Metric::new_float_gauge(&name, help),
            ...
            PrometheusMetric::MixnetLpInternalSpRoutedRate => Metric::new_float_gauge(&name, help),
...
mod tests {
    ...
    fn prometheus_metrics() {
        ...
        assert_eq!(84, PrometheusMetric::COUNT)
    }
