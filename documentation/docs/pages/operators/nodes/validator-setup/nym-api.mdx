...
You will most likely want to automate your validator restarting if your server reboots. Checkout the [maintenance page](../maintenance.mdx) for an example `service` file.
