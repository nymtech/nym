...
use wasm_client_core::helpers::{
    ...
    FakeWasmDkgClient, WasmBandwidthController,
};
...
pub(crate) type LockedGatewayClient =
    Arc<AsyncMutex<GatewayClient<FakeWasmDkgClient, EphemeralCredentialStorage>>>;
...
pub struct NymNodeTesterBuilder {
    ...
    // unimplemented
    bandwidth_controller: Option<WasmBandwidthController>,
}
...
impl NymNodeTesterBuilder {
    ...
    ) -> Result<InitialisationDetails, NodeTesterError> {
