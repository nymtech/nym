...
pub enum AuthenticatorVersion {
    ...
    /// introduced in aera release (1.1.9)
    V2,
    ...
    /// introduced in yet to be named release, currently aiming for Isabirra (1.19.0)
    V6,
    UNKNOWN,
}
...
impl AuthenticatorVersion {
    ...
    pub const fn release_version(&self) -> semver::Version {
        match self {
            ...
            AuthenticatorVersion::V6 => semver::Version::new(1, 19, 0),
...
impl From<semver::Version> for AuthenticatorVersion {
    fn from(semver: semver::Version) -> Self {
        ...
        debug_assert_eq!(Self::V6, Self::LATEST, "a new AuthenticatorVersion variant has been introduced without adjusting the `From<semver::Version>` trait");
        Self::LATEST
    }
}
...
mod tests {
    ...
    fn semver_checks() {
        ...
        assert_eq!(AuthenticatorVersion::V6, "1.19.0".into());
        assert_eq!(AuthenticatorVersion::V6, "1.20.0".into());
    }
}
