...
- [Delegation Program](https://nym.com/delegations-program) account is fully utilised. From now on delegations will happen once in two weeks and only to a limitted amount of nodes proportional to the amount of available NYM tokens. 
