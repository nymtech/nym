...
- **[Node Families](/docs/operators/nodes/nym-node/families) are live!**
  - **New version of [Nym wallet]() with family management menu**
  - [SpectreDAO Explorer](https://explorer.nym.spectredao.net/families) family overview is out**

- [Operators Cost](/docs/operators/tokenomics/mixnet-rewards#rewards-distribution) cap is raised to 10000 NYM, DP and SGP max cap is 5000 NYM.
...
- [API v2 enhancements](https://github.com/nymtech/nym/pull/6815) [#6889]: Introduced API v2 auxiliary details endpoint exposing node on-chain addresses and improved Swagger/OpenAPI versioning, routing, and documentation.
