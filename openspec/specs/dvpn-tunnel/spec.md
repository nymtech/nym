...
## Purpose
Defines the nym-smol-dvpn userspace WireGuard tunnel: boringtun datapath, single/two-hop modes, tokio traffic surfaces, lifecycle, DNS, MTU, and bandwidth top-up.
