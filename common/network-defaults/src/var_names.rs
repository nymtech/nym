...
pub const DIRECTORY_CONTRACT_ADDRESS: &str = "DIRECTORY_CONTRACT_ADDRESS";
pub const GEOLOCATION_CONTRACT_ADDRESS: &str = "GEOLOCATION_CONTRACT_ADDRESS";
...
/// Deprecated: use `ROOT_ATTESTER_ED25519_BS58_PUBKEY` instead
#[doc(hidden)]
